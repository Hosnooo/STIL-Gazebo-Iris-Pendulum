...
/*void StabController(const double x[13], const double Kv[15],
                    const double param[4], const double setpoint[3],
                    double u[3])
{
  double Ts1_idx_1;
  ...
  n3 = (-Kv[0] * Ts1_idx_1 -
        Kv[3] *
            ((x[2] + param[2] * b_Ts1_tmp_tmp * Ts1_tmp_tmp) - setpoint[2])) -
       Kv[6] * x[12];
  n3p = -Kv[0] * n3 - Ts1_idx_1 * Kv[3];
  n3pp = -Kv[0] * n3p - Kv[3] * n3;
  Ts1_idx_1 = param[3] - n3;
  n1_tmp = b_Ts1_tmp_tmp * b_Ts1_tmp_tmp;
  b_n1_tmp = Ts1_tmp_tmp * Ts1_tmp_tmp;
  n1 = (((-Kv[1] * (((n3p * Ts1_tmp_tmp * Ts1_tmp - x[9] * Ts1_idx_1) *
                         b_Ts1_tmp_tmp -
                     b_Ts1_tmp * x[8] * Ts1_tmp_tmp * Ts1_tmp * Ts1_idx_1) /
                    n1_tmp / b_n1_tmp) -
          -Ts1_tmp * Ts1_idx_1 / Ts1_tmp_tmp / b_Ts1_tmp_tmp * Kv[4]) -
         (x[5] + Ts1_idx_1_tmp * Ts1_tmp_tmp) * Kv[7]) -
        Kv[10] * ((x[0] + param[2] * Ts1_tmp) - setpoint[0])) -
  ...
  d_u_tmp = param[0] + param[1];
  e_u_tmp = u_tmp * a_tmp;
  u[0] = (((std::cos(x[3]) * param[2] *
                ((n1_tmp * n3pp - b_Ts1_tmp_tmp * b_Ts1_tmp * Ts1_idx_1) +
                 e_u_tmp) *
                param[0] * b_u_tmp +
            3.0 * param[2] * c_u_tmp * b_Ts1_tmp_tmp * param[0] * a_tmp *
                Ts1_tmp_tmp) +
          ...
          2.0 * param[2] * param[0] *
              (-b_n1_tmp * n1_tmp * n1 / 2.0 +
               (b_Ts1_tmp_tmp * n3p + x[8] * std::sin(x[3]) * a_tmp) * x[9]) *
              b_n1_tmp) /
         a_tmp / Ts1_tmp_tmp / b_Ts1_tmp_tmp;
  f_u_tmp = rt_powd_snf(Ts1_tmp_tmp, 4.0);
  b_u_tmp *= param[2];
  g_u_tmp = rt_powd_snf(b_Ts1_tmp_tmp, 3.0);
  u_tmp_tmp = 0.66666666666666663 * u_tmp;
  h_u_tmp = c_u_tmp + u_tmp_tmp;
  u[1] =
      ((((-b_Ts1_tmp_tmp * param[2] * param[0] *
              (((g_u_tmp * Ts1_idx_1 + n1_tmp * b_Ts1_tmp * n3pp) -
                Ts1_idx_1 * b_Ts1_tmp_tmp) +
               u_tmp * b_Ts1_tmp * a_tmp) *
              f_u_tmp -
          b_u_tmp * n1_tmp * Ts1_tmp * b_Ts1_tmp * param[0] * n1) -
         3.0 * b_Ts1_tmp_tmp * param[2] * param[0] *
             ((0.66666666666666663 * x[8] * n3p + Ts1_idx_1 / 3.0) *
                  b_Ts1_tmp_tmp +
              h_u_tmp * b_Ts1_tmp * a_tmp) *
             b_n1_tmp) +
        ((-4.0 * param[2] * x[9] * x[8] * Ts1_tmp * param[0] * a_tmp * n1_tmp +
          2.0 * param[2] * x[9] * Ts1_tmp * b_Ts1_tmp_tmp * b_Ts1_tmp *
              param[0] * n3p) +
         2.0 *
             (-d_u_tmp * a_tmp * b_Ts1_tmp / 2.0 +
              Ts1_idx_1_tmp * x[8] * Ts1_tmp * param[0]) *
             a_tmp) *
            Ts1_tmp_tmp) +
       2.0 * param[2] * c_u_tmp * b_Ts1_tmp_tmp * b_Ts1_tmp * param[0] *
           a_tmp) /
      a_tmp / Ts1_tmp_tmp / b_Ts1_tmp_tmp;
  u[2] =
      ((((param[2] * f_u_tmp * rt_powd_snf(b_Ts1_tmp_tmp, 4.0) * param[0] *
              n3pp -
          b_u_tmp * param[0] *
              (Ts1_tmp_tmp * b_Ts1_tmp * Ts1_idx_1 - Ts1_tmp * n1) * g_u_tmp) +
         3.0 *
             (((e_u_tmp * f_u_tmp / 3.0 +
                ((h_u_tmp * n3 + (-c_u_tmp - u_tmp_tmp) * param[3]) -
                 n3pp / 3.0) *
                    b_n1_tmp) -
               0.66666666666666663 * x[9] * Ts1_tmp_tmp * Ts1_tmp * n3p) -
              0.66666666666666663 * c_u_tmp * a_tmp) *
        ...
        4.0 *
            (b_Ts1_idx_1_tmp * Ts1_tmp_tmp * b_Ts1_tmp * param[0] * n3p / 2.0 +
             (param[2] * x[9] * x[8] * std::sin(x[4]) * b_Ts1_tmp * param[0] -
              d_u_tmp * a_tmp / 4.0) *
                 a_tmp) *
            Ts1_tmp_tmp * b_Ts1_tmp_tmp) -
       2.0 * param[2] * u_tmp * b_n1_tmp * param[0] * a_tmp) /
